...
void VL53L1CX_Init(void){                                                               // "VL53L1CX_Init"
    uint8_t     buffer[20];                                             // definiert "buffer"

	Slave_Address = VL53L1CX_ADDR;                                               // schreibt "VL53L1CX_ADDR" in "Slave_Address"

    buffer[0] = 0x01;
    buffer[1] = 0x0F;
    I2C1_MasterWrite(&buffer[0], 2, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    I2C1_MasterRead(&buffer[0], 2, Slave_Address, &status);               // ließt  Byte (buffer[0]) von I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf

    buffer[0] = 0x00;
    buffer[1] = 0x00;
    buffer[2] = 0x00;
    I2C1_MasterWrite(&buffer[0], 3, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    ...
    I2C1_MasterWrite(&buffer[0], 2, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    I2C1_MasterRead(&buffer[0], 1, Slave_Address, &status);               // ließt  Byte (buffer[0]) von I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    ...
    buffer[2] = 0x0A;
    buffer[3] = 0x00;
    I2C1_MasterWrite(&buffer[0], 4, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    ...
    buffer[4] = 0x07;
    buffer[5] = 0x3A;
    I2C1_MasterWrite(&buffer[0], 6, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    ...
    I2C1_MasterWrite(&buffer[0], 2, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    I2C1_MasterRead(&buffer[0], 12, Slave_Address, &status);               // ließt  Byte (buffer[0]) von I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    ...
    I2C1_MasterWrite(&buffer[0], 2, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    I2C1_MasterRead(&buffer[0], 17, Slave_Address, &status);               // ließt  Byte (buffer[0]) von I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
...
float VL53L1CX_Millimeter_GetValue(void){                                               // "VL53L1CX_Millimeter_GetValue"
    ...
    I2C1_MasterWrite(&buffer[0], 2, Slave_Address, &status);               // schreibt  Byte (buffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
    I2C1_MasterRead(&readBuffer[0], 17, Slave_Address, &status);               // ließt  Byte (buffer[0]) von I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
